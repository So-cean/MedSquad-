...
const MAP_TEXTURE_PATHS := {
	"MAP_ED_CORE": "res://assets/maps/normalized/map1_norm.png",
	"MAP_DIAGNOSTICS": "res://assets/maps/normalized/map2_norm.png",
	"MAP_DOWNSTREAM": "res://assets/maps/normalized/map3_norm.png",
}
