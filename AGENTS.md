...
| `assets/labrad_blue_frames/` | Labrad blue (检验员蓝) 8-direction 32×32 frame PNGs — same idle/walk format. Generated by `tools/slice_npc_sheets.py` from `character/labrad blue {idle,walk} 8dir.png` + `character/labrad blue.png` (standalone idle_down) |
| `assets/qa_gray_frames/` | QA gray (质控员灰) 8-direction 32×32 frame PNGs — same format. Generated from `character/qa gray {idle,walk} 8dir.png` + `character/qa gray.png` |
| `assets/doctor_red_frames/` | Doctor red (急诊医生红) 8-direction 32×32 frame PNGs — same format. Generated from `character/doctor red {idle,walk} 8dir.png` + `character/doctor red.png` |
| `assets/doctor_green_frames/` | Doctor green (急诊医生绿) 8-direction 32×32 frame PNGs — same format. Generated from `character/doctor green {idle,walk} 8dir.png` + `character/doctor green.png` |
...
| `tools/slice_npc_sheets.py` | Python script to slice 96×96 8-direction idle/walk sheets into individual 32×32 PNGs in `assets/{npc}_frames/`. Reusable for future NPCs. Grid mapping verified against existing nurse_frames. |
